...
angular.module('qorumApp')
    .controller('OrganizationsCreateTabsController',function ($scope, $rootScope, $window, $stateParams, User, Organization, OrganizationsCrud, Department, Project, orgToBeEdited) {
          $scope.tabs = [
            { title:'Organizatie'},
