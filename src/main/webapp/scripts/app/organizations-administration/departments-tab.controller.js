...
angular.module('qorumApp')
    .controller('DepartmentsTabController',function ($scope, $modalInstance, $rootScope, $window, $stateParams, User, Department, organizationSaved, OrganizationsCrud, departmentToBeEdited) {
