...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "qorum@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "qorum API";

        private String description = "qorum API documentation";
